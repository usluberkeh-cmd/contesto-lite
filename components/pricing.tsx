...
export function Pricing() {
  const features = [
    "Analyse IA complete",
    "Generation de contestation",
    "Revision par avocat",
    "Envoi aux autorites (ANTAI)",
        ...
        >
          <Card className="p-8 space-y-8 bg-card shadow-2xl border-2 border-primary/20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-center text-sm text-muted-foreground">
                Aucune carte bancaire requise pour l{"'"}analyse
              </p>
            </div>
          </Card>
          ...
          <div className="mt-8 text-center space-y-2">
            <p className="text-sm text-muted-foreground">
              Paiement securise par Stripe et PayPal
            </p>
            <p className="text-sm text-muted-foreground">
              Garantie 100% rembourse si le service ne fonctionne pas
            </p>
          </div>
        </AnimatedSection>
      </div>
